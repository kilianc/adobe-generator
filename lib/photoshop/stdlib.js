...
PSClass = {}
PSClass.BlurTool             = cTID("BlTl");
PSClass.BurnInTool           = cTID("BrTl");
PSClass.CloneStampTool       = cTID("ClTl");
PSClass.DodgeTool            = cTID("DdTl");
PSClass.EraserTool           = cTID("ErTl");
PSClass.GradientTool         = cTID("GrTl");
PSClass.HistoryBrushTool     = cTID("HBTl");
PSClass.MagicEraserTool      = cTID("MgEr");
PSClass.PaintbrushTool       = cTID("PbTl");
PSClass.PatternStampTool     = cTID("PaTl");
PSClass.PencilTool           = cTID("PcTl");
PSClass.SaturationTool       = cTID("SrTl");
PSClass.SharpenTool          = cTID("ShTl");
PSClass.BackgroundEraserTool = cTID("SETl");
PSClass.ArtHistoryBrushTool  = cTID("ABTl");
PSClass.SmudgeTool           = cTID("SmTl");
