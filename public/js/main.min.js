...
/*   25 */      layers.forEach(configureLayer)
/*   26 */    })
/*   27 */  
/*   28 */    socket.on('layerPngReady', function (layerId) {
/*   29 */      elements[layerId].to({
/*   30 */        'background-color': 'transparent',
/*   31 */        'background-image': 'url("images/layers/' + layers[layerId].name + '")'
/*   32 */      }).to({ opacity: 1 }, 1)
/*   33 */    })
/*   34 */  
/*   35 */    socket.emit('ready')
/*   36 */  
/*   37 */    function isFormatChanged(layer) {
/*   38 */      var element = elements[layer.id]
/*   39 */      var className = layer.kind.replace('LayerKind.').toLowerCase()
/*   40 */      return (element !== undefined && !element.hasClass(className))
/*   41 */    }
/*   42 */  
...
/*   48 */        if (ids.indexOf(layerId) === -1 || isFormatChanged(layer)) {
/*   49 */          elements[layerId].remove()
/*   50 */          ;delete elements[layerId]
/*   51 */        }
/*   52 */      })
/*   53 */    }
/*   54 */  
/*   55 */    function configureLayer(layer) {
/*   56 */      var element = elements[layer.id]
/*   57 */  
/*   58 */      if (element === undefined) {
/*   59 */        elements[layer.id] = createLayer(layer).appendTo(canvasElement)
/*   60 */      } else {
/*   61 */        element.css(getStyle(layer))
/*   62 */        if (layer.kind === 'LayerKind.TEXT') {
/*   63 */          element.text(layer.textContent)
/*   64 */        }
/*   65 */      }
/*   66 */  
/*   67 */      layers[layer.id] = layer
/*   68 */  
/*   69 */      if (layer.isSelected) {
/*   70 */        selectedLayer = layer
/*   71 */      }
/*   72 */    }
/*   73 */  
/*   74 */    function createLayer(layer) {
/*   75 */      var element
/*   76 */      var styles = getStyle(layer)
/*   77 */  
/*   78 */      switch (layer.kind) {
/*   79 */        case 'LayerKind.TEXT':
/*   80 */          element = $('<p id="ml-' + layer.id + '" class="text">' + layer.textContent + '</p>').css(styles)
/*   81 */          break
/*   82 */        case 'LayerKind.SOLIDFILL':
/*   83 */          element = $('<div id="ml-' + layer.id + '" class="solidfill"></div>').css(styles)
/*   84 */          break
/*   85 */        case 'LayerKind.NORMAL':
/*   86 */          element = $('<div id="ml-' + layer.id + '" class="normal"></div>').css(styles)
/*   87 */          break
/*   88 */      }
/*   89 */  
/*   90 */      return element.css('position', 'absolute')
/*   91 */    }
/*   92 */  
/*   93 */    function getStyle(layer) {
/*   94 */      var styles = {
/*   95 */        'left': layer.bounds[0] + 'px',
/*   96 */        'top': layer.bounds[1] + 'px',
/*   97 */        'width': (layer.bounds[2] - layer.bounds[0])  + 'px',
/*   98 */        'height': (layer.bounds[3] - layer.bounds[1])  + 'px',
/*   99 */        'display': layer.isVisible ? 'block' : 'none',
/*  100 */        'z-index': layer.index,
/*  101 */        'opacity': layer.opacity
/*  102 */      }
/*  103 */  
/*  104 */      switch (layer.kind) {
/*  105 */        case 'LayerKind.TEXT':
/*  106 */          styles.color = '#' + layer.textColor
/*  107 */          styles['font-family'] = layer.textFont
/*  108 */          styles['font-size'] = layer.textSize
/*  109 */        break
/*  110 */        case 'LayerKind.SOLIDFILL':
/*  111 */          styles['background-color'] = '#' + layer.fillColor
/*  112 */        break
/*  113 */        case 'LayerKind.NORMAL':
/*  114 */          styles.opacity = 1
/*  115 */          styles['background-color'] = 'transparent'
/*  116 */          styles['background-image'] = 'url("images/layers/' + layer.name + '")'
/*  117 */        break
/*  118 */      }
/*  119 */  
/*  120 */      return styles
