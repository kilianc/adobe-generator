...
/*   29 */        }
/*   30 */        layers[layer.id] = layer
/*   31 */      })
/*   32 */    })
/*   33 */  
/*   34 */    socket.on('layerPngReady', function (layerId) {
/*   35 */      elements[layerId].to({
/*   36 */        'background-color': 'transparent',
/*   37 */        'background-image': 'url("images/layers/' + layers[layerId].name + '")'
/*   38 */      }).to({ opacity: 1 }, 1)
/*   39 */    })
/*   40 */  
...
/*   75 */          element = element || $('<div id="ml-' + layer.id + '" class="text"></div>')
/*   76 */          element.empty().append(createParagraphs(layer))
/*   77 */          element.css(styles)
/*   78 */          break
/*   79 */        case 'LayerKind.SOLIDFILL':
/*   80 */          styles.backgroundColor = layer.fillColor
/*   81 */          element = element || $('<div id="ml-' + layer.id + '" class="solidfill"></div>')
/*   82 */          element.css(styles)
/*   83 */          break
/*   84 */        case 'LayerKind.NORMAL':
/*   85 */          styles.opacity = 1
/*   86 */          styles.backgroundColor = 'transparent'
/*   87 */          styles.backgroundImage = 'url("images/layers/' + layer.name + '")'
/*   88 */          element = element || $('<div id="ml-' + layer.id + '" class="normal"></div>')
...
/*   94 */    }
/*   95 */  
/*   96 */    function createParagraphs(layer) {
/*   97 */      var textStyles = layer.textStyles.slice(0)
/*   98 */      var textContent = layer.textContent
/*   99 */      var paragraphs = layer.paragraphStyles.map(function (paragraphStyle) {
/*  100 */        var spans = createSpansForParagraphs(textStyles, paragraphStyle.from, paragraphStyle.to, textContent)
/*  101 */        var p = $('<p>').css({
/*  102 */          textAlign: paragraphStyle.align,
/*  103 */          webkitHyphens: 'auto'
/*  104 */        }).append(spans)
/*  105 */  
/*  106 */        return p[0]
/*  107 */      })
/*  108 */  
/*  109 */      return paragraphs
/*  110 */    }
/*  111 */  
/*  112 */    function createSpansForParagraphs(textStyles, from, to, textContent) {
/*  113 */      var textStyle, spanText, css, spans = []
/*  114 */      var stylesRanges = []
/*  115 */  
/*  116 */      for (var i = 0, l = textStyles.length; i < l; i++) {
/*  117 */        textStyle = textStyles[i]
/*  118 */  
/*  119 */        // hack related to https://github.com/kilianc/motherlover/issues/33
/*  120 */        if (stylesRanges.indexOf(textStyle.from + ':' + textStyle.to) !== -1) continue
/*  121 */        stylesRanges.push(textStyle.from + ':' + textStyle.to)
/*  122 */  
/*  123 */        if (textStyle.to < from) continue
/*  124 */        if (textStyle.from > to) break
/*  125 */  
/*  126 */        spanText = textContent.substring(Math.max(textStyle.from, from), Math.min(textStyle.to, to)).replace('\n', '<br>')
/*  127 */  
/*  128 */        css = {
/*  129 */          font: textStyle.size + 'px "' + textStyle.fontPostScriptName + '"',
/*  130 */          color: textStyle.color
/*  131 */        }
/*  132 */  
/*  133 */        if (textStyle.underline === 'underlineOnLeftInVertical') {
/*  134 */          css.textDecoration = 'underline'
/*  135 */        }
/*  136 */        if (textStyle.strikethrough === 'xHeightStrikethroughOn') {
/*  137 */          css.textDecoration = css.textDecoration ? css.textDecoration + ' line-through' : 'line-through'
/*  138 */        }
/*  139 */        if (textStyle.fontCaps === 'allCaps') {
/*  140 */          css.textTransform = 'uppercase'
/*  141 */        } else if (textStyle.fontCaps === 'smallCaps') {
/*  142 */          css.fontVariant = 'small-caps'
/*  143 */        }
/*  144 */  
/*  145 */        spans.push($('<span>').text(spanText).css(css)[0])
/*  146 */      }
/*  147 */  
/*  148 */      return spans
/*  149 */    }
