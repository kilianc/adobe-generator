var map = [{"line":3824,"filename":"js/vendor/socket.io.js"},{"line":3834,"filename":"js/vendor/jquery-1.7.2.min.js"},{"line":3997,"filename":"js/main.js"}]
/**
...
/*  107 */        var spans = createSpansForParagraphs(textStyles, paragraphStyle.from, paragraphStyle.to, textContent)
/*  108 */        var p = $('<p>').css({
...
/*  117 */    }
/*  118 */  
/*  119 */    function createSpansForParagraphs(textStyles, from, to, textContent) {
...
/*  134 */  
/*  135 */        css = {
/*  136 */          font: textStyle.size + 'px "' + textStyle.fontPostScriptName + '"',
/*  137 */          color: textStyle.color
/*  138 */        }
/*  139 */  
/*  140 */        if (textStyle.underline === 'underlineOnLeftInVertical') {
/*  141 */          css.textDecoration = 'underline'
/*  142 */        }
/*  143 */        if (textStyle.strikethrough === 'xHeightStrikethroughOn') {
/*  144 */          css.textDecoration = css.textDecoration ? css.textDecoration + ' line-through' : 'line-through'
/*  145 */        }
/*  146 */        if (textStyle.fontCaps === 'allCaps') {
/*  147 */          css.textTransform = 'uppercase'
/*  148 */        } else if (textStyle.fontCaps === 'smallCaps') {
/*  149 */          css.fontVariant = 'small-caps'
/*  150 */        }
/*  151 */  
/*  152 */        spans.push($('<span>').text(spanText).css(css)[0])
/*  153 */      }
/*  154 */  
/*  155 */      return spans
/*  156 */    }
